...
var eventemitter3_1 = __webpack_require__(19);
var audio_1 = __webpack_require__(2);
var soundcloud_1 = __webpack_require__(4);
var tracks = [];
...
var Events = (function (_super) {
    ...
    Events.prototype.emit = function (event) {
        ...
        var result = _super.prototype.emit.apply(this, [event].concat(args));
        if (event !== 'all')
            this.emit('all', tracks);
        return result;
    };
    return Events;
...
exports.setTracks = function (scTracks) {
    ...
    exports.events.emit('listchange', tracks);
    exports.events.emit('trackchange', null);
};
...
exports.playTrack = function (index) {
    ...
    exports.events.emit('playpause', true);
};
exports.pauseTrack = function (index) {
    var track = tracks[index];
    if (!track)
        return;
    isPlaying = false;
    ...
    exports.events.emit('playpause', false);
};
...
audio_1.default.addEventListener('ended', exports.nextTrack);
...
var dataArrayL = new Uint8Array(analyserL.frequencyBinCount);
var dataArrayR = new Uint8Array(analyserR.frequencyBinCount);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.check = function () { return Boolean(document.fullscreenElement ||
    document['msFullScreenElement'] ||
    document['mozFullScreenElement'] ||
    document.webkitFullscreenElement); };
exports.enter = function (element) {
...
exports.onChange = function (listener) {
    ...
    eventNames.some(function (eventName) {
...
exports.getScale = function (element, scale) {
    ...
    var targetHeight = screenHeight * scale;
    var targetWidth = screenWidth * scale;
...
var soundcloud = __webpack_require__(4);
var scroll_1 = __webpack_require__(18);
var Footer_1 = __webpack_require__(9);
var SeekBar_1 = __webpack_require__(11);
var TrackTable_1 = __webpack_require__(13);
var UrlLoader_1 = __webpack_require__(14);
var Visualizer_1 = __webpack_require__(15);
var WIDTH = 600;
var HEIGHT = 600;
var BORDER_X = 7;
var BORDER_Y = 8;
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement("div", { className: "container", style: { width: WIDTH + BORDER_X * 2 + "px" } },
...
exports.default = App;
var getLocationHash = function () { return (window.location.hash &&
    window.location.hash.length > 1 &&
    window.location.hash.slice(1)) || ''; };
var loadHashTracks = function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
exports.default = function () { return (React.createElement("div", { className: "footer" },
    React.createElement("a", { href: "https://soundcloud.com", title: "SoundCloud – Listen to free music and podcasts on SoundCloud", target: "_blank" }, "SoundCloud"),
    "\u25D2",
    React.createElement("a", { href: "https://en.wikipedia.org/wiki/Spectrogram", title: "Spectrogram – Wikipedia, the free encyclopedia", target: "_blank" }, "Spectrogram"))); };
...
var SeekBar = (function (_super) {
    ...
    function SeekBar() {
        ...
        var track = playlist.getCurrentTrack() || tracks[0];
        _this.state = {
            currentTime: audio_1.audio.currentTime || 0,
            duration: audio_1.audio.duration || 0,
            trackCount: tracks.length,
            waveform: track && track.waveform_url,
        };
        {
            var isMouseDown_1 = false;
            var targetLeft_1 = null;
            var targetWidth_1 = null;
            var seek_1 = throttle(function (pageX) {
                var duration = _this.state.duration;
                if (!duration)
                    return;
                var left = Math.max((pageX - targetLeft_1) / targetWidth_1, 0);
                var time = Math.min(left * duration, duration);
                audio_1.audio.currentTime = time;
            }, 100, { leading: false });
            _this.onMouseDown = function (e) {
                ...
                targetLeft_1 = rect.left;
                targetWidth_1 = rect.width;
                seek_1(e.pageX);
            };
    ...
    SeekBar.prototype.render = function () {
        if (!this.state.trackCount)
            return null;
        var height = 24;
        var paddingX = 3;
        var paddingY = 0;
        var thickness = 1;
        var progress = this.state.duration
            ? this.state.currentTime / this.state.duration
            : 0;
        return (React.createElement("div", { onMouseDown: this.onMouseDown, style: {
                position: 'relative',
            ...
            React.createElement("div", { style: {
                ...
                this.state.waveform &&
                    React.createElement("div", { style: {
                        ...
                        React.createElement("img", { src: this.state.waveform, width: "100%", height: "100%", style: {
                                filter: 'brightness(2)',
    ...
    SeekBar.prototype.componentDidMount = function () {
        var _this = this;
        playlist.events.on('trackchange', function (track) {
            track = track || playlist.getTracks()[0];
            _this.setState({ waveform: track && track.waveform_url });
        });
        playlist.events.on('listchange', function (tracks) {
            var track = playlist.getCurrentTrack() || tracks[0];
            _this.setState({
                trackCount: tracks.length,
                waveform: track && track.waveform_url,
...
exports.default = function (_a) {
    ...
    var thumbUrl = track.artwork_url || track.user.avatar_url || '';
    ...
    return (React.createElement("tr", null,
        React.createElement("td", { className: "thumb" },
            React.createElement("a", { href: "#", title: trackAction, onClick: function (e) { return handleClick(e, track); }, style: {
                ...
                React.createElement("img", { src: thumbUrl, width: "32", height: "32" }))),
...
var throttle = __webpack_require__(5);
var playlist = __webpack_require__(1);
var TrackRow_1 = __webpack_require__(12);
var TrackTable = (function (_super) {
    __extends(TrackTable, _super);
    function TrackTable() {
        var _this = _super.call(this) || this;
        _this.state = { tracks: playlist.getTracks() };
        return _this;
    }
    TrackTable.prototype.render = function () {
        return (React.createElement("table", { className: "track-table" },
            React.createElement("tbody", null, this.state.tracks.map(function (track) { return (React.createElement(TrackRow_1.default, { key: track.id, track: track })); }))));
    };
    TrackTable.prototype.componentDidMount = function () {
        var _this = this;
        playlist.events.on('all', throttle(function (tracks) { return _this.setState({ tracks: tracks }); }, { leading: false }));
    };
    return TrackTable;
}(React.Component));
...
var audio_1 = __webpack_require__(2);
var playlist_1 = __webpack_require__(1);
var FullscreenBtn_1 = __webpack_require__(10);
var Visualizer = (function (_super) {
    __extends(Visualizer, _super);
    function Visualizer(props) {
        var _this = _super.call(this, props) || this;
        _this.upperHeight = 1 * (props.height / 6);
        _this.lowerHeight = 5 * (props.height / 6);
    ...
    Visualizer.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (el) { return _this.container = el; }, className: "visualizer", style: {
    ...
    Visualizer.prototype.animate = function (mountSignature) {
        var _this = this;
        // bail if closure & class signature don't match
        if (mountSignature !== this.mountSignature)
            return;
        var channels = audio_1.getChannels();
        draw.spectrogram({
            x: 0,
            y: 0,
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.spectrogram = function (_a) {
    var x = _a.x, y = _a.y, width = _a.width, height = _a.height, context = _a.context, channels = _a.channels;
    context.fillStyle = '#333';
    context.fillRect(x, y, width, height);
    var rectCount = channels[0].length;
    var rectWidth = width / 2 / rectCount;
    channels.forEach(function (channel, index) {
        for (var i = 0; i < rectCount; i++) {
            var magnitude = channel[i] / 255;
            var hue = magnitude * 300;
            var rectHeight = magnitude * height;
            context.fillStyle = "hsl(" + hue + ", 64%, 64%)";
            context.fillRect(index === 0 // left channel?
                ? x + width / 2 - rectWidth * i
                : x + width / 2 + rectWidth * i, y + height - rectHeight, rectWidth + 1, rectHeight);
        }
    });
};
exports.waterfall = function (_a) {
    var x = _a.x, y = _a.y, width = _a.width, height = _a.height, context = _a.context, channels = _a.channels;
    ...
    channels.forEach(function (channel, index) {
        for (var i = 0; i < rectCount; i++) {
            ...
            var hue = magnitude * 300;
            context.fillStyle = "hsl(" + hue + ", 64%, 64%)";
            context.fillRect(index === 0
                ? x + width / 2 - rectWidth * i
                : x + width / 2 + rectWidth * i, y, rectWidth + 1, rectHeight + 1);
        }
    });
...
Object.defineProperty(exports, "__esModule", { value: true });
var scroll = __webpack_require__(22);
var target = document.getElementById('app');
exports.default = function () { return scroll.top(target, 0, { duration: 300 }); };
